...
//				$meeting->recording_files = bp_zoom_meeting_get_meta( $meeting_id, 'zoom_recording_files', true );
	...
	public static function get_meeting_by_meeting_id( $meeting_id = 0 ) {
		...
		return $wpdb->get_row( $wpdb->prepare( "SELECT * FROM {$bp->table_prefix}bp_zoom_meetings WHERE meeting_id = %s", $meeting_id ) );
	}
}
